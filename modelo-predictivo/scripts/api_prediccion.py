...
# 4. Permitir CORS para frontend local
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
# 5. Ruta para predecir usando el código del estudiante
...
def predecir_desde_supabase(codigo_estudiante: str):
    ...
    fila = response.data[0]  # solo debe haber una fila por código

    # Filtrar solo las features (excluye 'codigo_estudiante')
